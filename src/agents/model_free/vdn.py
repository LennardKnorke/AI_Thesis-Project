...
class VDN_CentralPlanner(AgentList):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        # 2. Create Agents
        agent_0 = VDN_Agent(env, num_cards, num_actions, self.q_table, self.buffer, self.epsilon)
        agent_1 = VDN_Agent(env, num_cards, num_actions, self.q_table, self.buffer, self.epsilon)
